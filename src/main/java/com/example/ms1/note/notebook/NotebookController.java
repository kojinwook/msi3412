...
public class NotebookController {
    ...
    public String detail(@PathVariable("id")Long id, ParamHandler paramHandler){
        ...
        return paramHandler.getParamUrl("/books/%d/notes/%d".formatted(id,note.getId()));
    }
    ...
    public String update(@PathVariable("id") Long id, Long targetNoteId, 
                         String name, ParamHandler paramHandler){
